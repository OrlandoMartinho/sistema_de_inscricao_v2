...
<body>
									...
									<ul class="nav menu">
										...
										<li><a href="#">Eventos <i class="icofont-rounded-down"></i></a>
											<ul class="dropdown">
												...
												<li><a href="estadoCandidatura.html">Vereficar estado de candidatura</a>
												</li>
											</ul>
										</li>
	...
	<section class="slider">
		<div class="hero-slider">
			...
			<div class="single-slider" style="background-image:url('img/ac.jpg')">
				<div class="container">
					<div class="row">
						<div class="col-lg-7">
							<div class="text">
								<h1 class="text_h1">Instituto <span>politécnico</span> nº2023<span>30 De Setembro</span></h1>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris sed nisl
									pellentesque, faucibus libero eu, gravida quam. </p>
								<div class="button">
									<a href="#formulario" class="btn">Inscrição</a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="single-slider" style="background-image:url('img/ac.jpg ')">
				<div class="container">
					<div class="row">
						<div class="col-lg-7">
							<div class="text">
								<h1>Instituto <span>politécnico</span> nº2023<span>30 De Setembro</span></h1>
								<p>Não perca mais tempo faça a sua inscrição de candidatura </p>
								<div class="button">
									<a href="#formulario" class="btn">Inscrição</a>
